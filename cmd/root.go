...
var rootCmd = &cobra.Command{
	Use:   "cidr",
	Short: "Simple command line utility for calculating networks based on IP addresses and mask bits",
	Long:  `Simple command line utility for calculating networks based on IP addresses and mask bits.`,
